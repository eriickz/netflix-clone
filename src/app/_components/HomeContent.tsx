...
import ContentHeading from "@/app/_components/ContentHeading";
        ...
        {isStrangerThingsSection && (
          <>
            <div className="flex justify-center items-end basis-auto order-last md:basis-1/2 md:order-first">
              ...
              <div
                className="flex items-center border-2 border-home-input-border absolute z-1 px-3 py-2 rounded-xl bg-black w-[80%] sm:mb-[38px] md:w-[32%] lg:w-[24%] lg:mb-[2%] xl:w-[20%]">
