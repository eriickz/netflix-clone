...
const Home = () => {
  const { collections } = useContentRetriever()

  console.log(collections)

  return (
    <main className="transition-all duration-100 ease-in">
      <div className="relative">
        <Header/>
        <Image alt="Home Top Background Image" src="/images/app-home-1.webp" width={0} height={0} sizes="100vh" fill objectFit="cover" unoptimized />
