...
import Top10 from "./components/icons/Top10";
...
const App = () => {
  return (
    <main className="w-full h-[1000px] bg-choose-profile-background">
      <div className="absolute w-full h-full bg-[url('/images/app-home-1.webp')] bg-no-repeat bg-cover z-1"></div>
